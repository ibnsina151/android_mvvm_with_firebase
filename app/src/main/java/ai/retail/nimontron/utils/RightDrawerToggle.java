...
/**
 * Created by Ibn Sina Munim on 11/19/18.
 */
...
public class RightDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public RightDrawerToggle(Activity activity, DrawerLayout drawerLayout, Toolbar toolbar,
